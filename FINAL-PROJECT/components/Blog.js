...
export default function Blog()
{
    return(
        ...
        <div className="bpage">
 			...
 			<h1><span>Vehicle Service Booking portal for reservation</span></h1>			
            
 			<Paper style={{width:'80%',padding:'5%'}}>
                <p><div className="tex"><strong>How does it work?</strong></div>
...
<strong>1.</strong> They’re Available 24/7
...
<br></br>
<br></br>
<strong>2.</strong>  Easy Management of Reservations
...
<strong>3.</strong>  Get a Deeper Insight In Business
...
<br></br>
<br></br>
<strong>4.</strong>  Enjoy Higher Profits & More Sales
...
<strong>5.</strong>  Automatic Renewal Of Availability Status
